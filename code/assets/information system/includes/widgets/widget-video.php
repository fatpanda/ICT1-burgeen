...
class tie_video_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php elseif ( $youtube_video ):?>
			<iframe width="100%" height="210" src="http://www.youtube.com/embed/<?php echo $youtube_video ?>?rel=0&wmode=opaque" frameborder="0" allowfullscreen></iframe>
		<?php elseif ( $vimeo_video ):?>
			<iframe src="http://player.vimeo.com/video/<?php echo $vimeo_video ?>?wmode=opaque" width="100%" height="210" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
		<?php endif; ?>
