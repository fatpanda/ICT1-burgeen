...
// HomeBuilder
	...
	jQuery(".tie_add-cat").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('	<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head"> News Box <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div style="display:block" class="widget-content"><label><span>Box Category : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id]" id="tie_home_cats'+builderno+'['+ nextCell +'][id]">'+htm1l+'</select></label><label><span>Posts Order : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][order]" id="tie_home_cats'+builderno+'['+ nextCell +'][order]"><option value="latest" selected="selected">Latest Posts</option><option value="rand">Random Posts</option></select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][number]" name="tie_home_cats'+builderno+'['+ nextCell +'][number]" value="4" type="text" /></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][offset]" name="tie_home_cats'+builderno+'['+ nextCell +'][offset]" value="" type="text"></label><label><span style="float:left; width:162px">Box Style : </span><ul class="tie-cats-options tie-options"><li class="selected"><input id="tie_home_cats'+builderno+'['+ nextCell +'][style]" name="tie_home_cats'+builderno+'['+ nextCell +'][style]" type="radio" value="li" checked="checked"/><a class="checkbox-select" href="#"><img src="'+ templatePath +'/panel/images/li.png" /></a></li><li><input id="tie_home_cats'+builderno+'['+ nextCell +'][style]" name="tie_home_cats'+builderno+'['+ nextCell +'][style]" type="radio" value="2c" /><a class="checkbox-select" href="#"><img src="'+ templatePath +'/panel/images/2c.png" /></a></li><li><input id="tie_home_cats'+builderno+'['+ nextCell +'][style]" name="tie_home_cats'+builderno+'['+ nextCell +'][style]" type="radio" value="1c" /><a class="checkbox-select" href="#"><img src="'+ templatePath +'/panel/images/1c.png" /></a></li></ul></label><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="n" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
	jQuery(".tie_add-slider").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head"> Scrolling Box <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div class="widget-content" style="display:block"><label><span>Box Category : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id]" id="tie_home_cats'+builderno+'['+ nextCell +'][id]">'+htm1l+'</select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][title]"><span>Box Title :</span><input id="tie_home_cats'+builderno+'['+ nextCell +'][title]" name="tie_home_cats'+builderno+'['+ nextCell +'][title]" value="Scrolling Box" type="text" /></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][number]" name="tie_home_cats'+builderno+'['+ nextCell +'][number]" value="12" type="text" /></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][offset]" name="tie_home_cats'+builderno+'['+ nextCell +'][offset]" value="" type="text"></label><input id="tie_home_cats'+builderno+'['+ nextCell +'][boxid]" name="tie_home_cats'+builderno+'['+ nextCell +'][boxid]" value="s_'+ 1 + Math.floor(Math.random() * 1500)+'" type="hidden" /><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="s" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
	jQuery(".tie_add-news-picture").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head">  News In Picture <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div class="widget-content" style="display:block"><label><span>Box Category : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id]" id="tie_home_cats'+builderno+'['+ nextCell +'][id]">'+htm1l+'</select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][title]"><span>Box Title :</span><input id="tie_home_cats'+builderno+'['+ nextCell +'][title]" name="tie_home_cats'+builderno+'['+ nextCell +'][title]" value="News In Picture" type="text" /></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][offset]" name="tie_home_cats'+builderno+'['+ nextCell +'][offset]" value="" type="text"></label><input id="tie_home_cats'+builderno+'['+ nextCell +'][boxid]" name="tie_home_cats'+builderno+'['+ nextCell +'][boxid]" value="news-pic_'+ 1 + Math.floor(Math.random() * 1500)+'" type="hidden" /><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="news-pic" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
	jQuery(".tie_add-divider").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head divider"> Divider <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div class="widget-content" style="display:block"><label for="tie_home_cats'+builderno+'['+ nextCell +'][height]"><span>Height :</span><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="divider" type="hidden" />  <input id="tie_home_cats'+builderno+'['+ nextCell +'][height]" name="tie_home_cats'+builderno+'['+ nextCell +'][height]" value="10" type="text" style="width:50px;" /> px</label>  <a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
	jQuery(".tie_add-recent").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head">  Recent Posts  <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div style="display:block" class="widget-content"><label><span style="float:left;">Exclude Categories : </span><select multiple="multiple" name="tie_home_cats'+builderno+'['+ nextCell +'][exclude][]" id="tie_home_cats'+builderno+'['+ nextCell +'][exclude][]">'+htm1l+'</select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][title]"><span>Box Title :</span><input id="tie_home_cats'+builderno+'['+ nextCell +'][title]" name="tie_home_cats'+builderno+'['+ nextCell +'][title]" value="Recent Posts" type="text" /></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][number]" name="tie_home_cats'+builderno+'['+ nextCell +'][number]" value="3" type="text" /></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][offset]" name="tie_home_cats'+builderno+'['+ nextCell +'][offset]" value="" type="text"></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][display]"><span>Display Mode:</span><select id="tie_home_cats'+builderno+'['+ nextCell +'][display]" name="tie_home_cats'+builderno+'['+ nextCell +'][display]"><option value="default">Default Style</option><option value="blog">Blog Style</option></select></label>  <label for="tie_home_cats'+builderno+'['+ nextCell +'][pagi]"><span>Show Pagination:</span><select id="tie_home_cats'+builderno+'['+ nextCell +'][pagi]" name="tie_home_cats'+builderno+'['+ nextCell +'][pagi]"><option value="n" selected="selected">No</option><option value="y">Yes</option></select></label><p class="tie_message_hint">WordPress WARNING: Setting the offset option breaks pagination, set pagination option to "NO" if you want to use the offset option.</p> <input id="tie_home_cats'+builderno+'['+ nextCell +'][boxid]" name="tie_home_cats'+builderno+'['+ nextCell +'][boxid]" value="recent_'+ 1 + Math.floor(Math.random() * 1500)+'" type="hidden" /> <input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="recent" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
	
	jQuery(".tie_add-ads").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head">  Ads / Custom Content <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div class="widget-content" style="display:block"><textarea name="tie_home_cats'+builderno+'['+ nextCell +'][text]" id="tie_home_cats'+builderno+'['+ nextCell +'][text]"></textarea><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="ads" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
	
	jQuery(".tie_add-wide-cat").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('	<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head"> News Box <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div style="display:block" class="widget-content"><label><span>Box Category : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id]" id="tie_home_cats'+builderno+'['+ nextCell +'][id]">'+htm1l+'</select></label><label><span>Posts Order : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][order]" id="tie_home_cats'+builderno+'['+ nextCell +'][order]"><option value="latest" selected="selected">Latest Posts</option><option value="rand">Random Posts</option></select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][number]" name="tie_home_cats'+builderno+'['+ nextCell +'][number]" value="4" type="text" /></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][offset]" name="tie_home_cats'+builderno+'['+ nextCell +'][offset]" value="" type="text"></label><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="n" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
	...
	jQuery(".tie_add-wide-reviews").click(function() {
		var builderno = jQuery(this).attr('data-num');
		var builderID = jQuery(this).attr('data-id');
		jQuery(builderID).append('	<li id="listItem_'+ nextCell +'" class="ui-state-default"><div class="widget-head"> Reviews Box <a style="display:none" class="toggle-open">+</a><a style="display:block" class="toggle-close">-</a></div><div style="display:block" class="widget-content"><label for="tie_home_cats'+builderno+'['+ nextCell +'][title]"><span>Box Title :</span><input id="tie_home_cats'+builderno+'['+ nextCell +'][title]" name="tie_home_cats'+builderno+'['+ nextCell +'][title]" value="Best Reviews" type="text" /></label><label><span>Box Category 1 : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id1]" id="tie_home_cats'+builderno+'['+ nextCell +'][id1]">'+htm1l+'</select></label><label><span>Box Category 2 : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id2]" id="tie_home_cats'+builderno+'['+ nextCell +'][id2]">'+htm1l+'</select></label><label><span>Box Category 3 : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][id3]" id="tie_home_cats'+builderno+'['+ nextCell +'][id3]">'+htm1l+'</select></label><label><span>Posts Order : </span><select name="tie_home_cats'+builderno+'['+ nextCell +'][order]" id="tie_home_cats'+builderno+'['+ nextCell +'][order]"><option value="latest" selected="selected">Latest Reviews</option><option value="rand">Random Reviews</option><option value="best">Best Reviews</option></select></label><label for="tie_home_cats'+builderno+'['+ nextCell +'][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats'+builderno+'['+ nextCell +'][number]" name="tie_home_cats'+builderno+'['+ nextCell +'][number]" value="4" type="text" /></label><input id="tie_home_cats'+builderno+'['+ nextCell +'][boxid]" name="tie_home_cats'+builderno+'['+ nextCell +'][boxid]" value="rev_'+ 1 + Math.floor(Math.random() * 1500)+'" type="hidden" /><input id="tie_home_cats'+builderno+'['+ nextCell +'][type]" name="tie_home_cats'+builderno+'['+ nextCell +'][type]" value="rev" type="hidden" /><a class="del-cat"></a></div></li>');
		jQuery('#listItem_'+ nextCell).hide().fadeIn();
		nextCell ++ ;
	});
...
// Panel Tabs
	...
	jQuery("#tie_theme_layout input:checked").parent().addClass("selected");
	jQuery("#tie_theme_layout .checkbox-select").click(
		function(event) {
			event.preventDefault();
			jQuery("#tie_theme_layout li").removeClass("selected");
			jQuery(this).parent().addClass("selected");
			jQuery(this).parent().find(":radio").attr("checked","checked");			 
		}
	);	
