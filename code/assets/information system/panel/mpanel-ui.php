			...
			<div class="tiepanel-item"  style=" overflow: visible; ">
								...
								<?php 
									if( $cat['type'] == 'n' ) :	?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats1[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats1[<?php echo $i ?>][number]" name="tie_home_cats1[<?php echo $i ?>][number]" value="<?php  echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats1[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats1[<?php echo $i ?>][offset]" name="tie_home_cats1[<?php echo $i ?>][offset]" value="<?php  echo $cat['offset']  ?>" type="text" /></label>
								...
								<?php 
									elseif( $cat['type'] == 'recent' ) :	?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats1[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats1[<?php echo $i ?>][title]" name="tie_home_cats1[<?php echo $i ?>][title]" value="<?php  echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats1[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats1[<?php echo $i ?>][number]" name="tie_home_cats1[<?php echo $i ?>][number]" value="<?php  echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats1[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats1[<?php echo $i ?>][offset]" name="tie_home_cats1[<?php echo $i ?>][offset]" value="<?php  echo $cat['offset']  ?>" type="text" /></label>
									...
									<?php elseif( $cat['type'] == 'ads' ) : ?>
										...
										<div class="widget-content">
											<textarea cols="36" rows="5" name="tie_home_cats1[<?php echo $i ?>][text]" id="tie_home_cats1[<?php echo $i ?>][text]"><?php echo stripslashes($cat['text']) ; ?></textarea>
									...
									<?php elseif( $cat['type'] == 'divider' ) : ?>
										...
										<div class="widget-content">
											<label for="tie_home_cats1[<?php echo $i ?>][height]"><span>Height :</span><input id="tie_home_cats1[<?php echo $i ?>][height]" name="tie_home_cats1[<?php echo $i ?>][height]" value="<?php  echo $cat['height']  ?>" type="text" style="width:50px;" /> px</label>
							...
							if($cats){
								...
								<?php 
									if( $cat['type'] == 'n' ) :	?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats2[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][offset]" name="tie_home_cats2[<?php echo $i ?>][offset]" value="<?php  echo $cat['offset']  ?>" type="text" /></label>

											<label for="tie_home_cats2[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][number]" name="tie_home_cats2[<?php echo $i ?>][number]" value="<?php  echo $cat['number']  ?>" type="text" /></label>
									...
									<?php elseif( $cat['type'] == 's' ) : ?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats2[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats2[<?php echo $i ?>][title]" name="tie_home_cats2[<?php echo $i ?>][title]" value="<?php  echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats2[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][number]" name="tie_home_cats2[<?php echo $i ?>][number]" value="<?php  echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats2[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][offset]" name="tie_home_cats2[<?php echo $i ?>][offset]" value="<?php  echo $cat['offset']  ?>" type="text" /></label>
								...
								<?php
									...
									<?php elseif( $cat['type'] == 'ads' ) : ?>
										...
										<div class="widget-content">
											<textarea cols="36" rows="5" name="tie_home_cats2[<?php echo $i ?>][text]" id="tie_home_cats2[<?php echo $i ?>][text]"><?php echo stripslashes($cat['text']) ; ?></textarea>
				...
				<div class="option-item">
					...
					<div class="home-builder-buttons">
						...
						<a class="tie_add-news-picture" data-id="#cat_sortable3" data-num="3">News in picrure</a>
								...
								<?php 
									if( $cat['type'] == 'n' ) :	?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats3[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats3[<?php echo $i ?>][number]" name="tie_home_cats3[<?php echo $i ?>][number]" value="<?php  echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats3[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats3[<?php echo $i ?>][offset]" name="tie_home_cats3[<?php echo $i ?>][offset]" value="<?php  echo $cat['offset']  ?>" type="text" /></label>
								...
								<?php 
									elseif( $cat['type'] == 'recent' ) :	?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats3[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats3[<?php echo $i ?>][title]" name="tie_home_cats3[<?php echo $i ?>][title]" value="<?php  echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats3[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats3[<?php echo $i ?>][number]" name="tie_home_cats3[<?php echo $i ?>][number]" value="<?php  echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats3[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats3[<?php echo $i ?>][offset]" name="tie_home_cats3[<?php echo $i ?>][offset]" value="<?php  echo $cat['offset']  ?>" type="text" /></label>
									...
									<?php elseif( $cat['type'] == 'ads' ) : ?>
										...
										<div class="widget-content">
											<textarea cols="36" rows="5" name="tie_home_cats3[<?php echo $i ?>][text]" id="tie_home_cats3[<?php echo $i ?>][text]"><?php echo stripslashes($cat['text']) ; ?></textarea>
									...
									<?php elseif( $cat['type'] == 'divider' ) : ?>
										...
										<div class="widget-content">
											<label for="tie_home_cats3[<?php echo $i ?>][height]"><span>Height :</span><input id="tie_home_cats3[<?php echo $i ?>][height]" name="tie_home_cats3[<?php echo $i ?>][height]" value="<?php  echo $cat['height']  ?>" type="text" style="width:50px;" /> px</label>
							...
							if($cats){
								...
								<?php 
									if( $cat['type'] == 'n' ) :	?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats4[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][number]" name="tie_home_cats4[<?php echo $i ?>][number]" value="<?php  echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats4[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][offset]" name="tie_home_cats4[<?php echo $i ?>][offset]" value="<?php  echo $cat['offset']  ?>" type="text" /></label>
									...
									<?php elseif( $cat['type'] == 's' ) : ?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats4[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats4[<?php echo $i ?>][title]" name="tie_home_cats4[<?php echo $i ?>][title]" value="<?php  echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats4[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][number]" name="tie_home_cats4[<?php echo $i ?>][number]" value="<?php  echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats4[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][offset]" name="tie_home_cats4[<?php echo $i ?>][offset]" value="<?php  echo $cat['offset']  ?>" type="text" /></label>
								...
								<?php
									...
									<?php elseif( $cat['type'] == 'ads' ) : ?>
										...
										<div class="widget-content">
											<textarea cols="36" rows="5" name="tie_home_cats4[<?php echo $i ?>][text]" id="tie_home_cats4[<?php echo $i ?>][text]"><?php echo stripslashes($cat['text']) ; ?></textarea>
