<?php
add_action( 'widgets_init', 'authors_posts_widget' );
function authors_posts_widget() {
	register_widget( 'authors_posts' );
}
class authors_posts extends WP_Widget {

	function authors_posts() {
	...
	function form( $instance ) {
		$defaults = array( 'cat_posts_title' =>__( 'Authors Posts' , 'tie'), 'no_of_posts' => '5' , 'cats_id' => '1' , 'thumb' => 'true' );
